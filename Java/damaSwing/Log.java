...
public class Log {
	private String file;
	private Vector<String> mosse = new Vector<String>(100, 100);
	private Vector<String> mostra = new Vector<String>(50, 10);
	private int place;
	...
	public void avanti() {
		if (getPlace() + 1 <= mostra.size() && getPlace() + 1 >= 0) setPlace(getPlace() + 1);
	}
