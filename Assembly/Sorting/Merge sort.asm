...
; set segment registers:
    ...
    ; add your code here
    lea dx,array ; salva in dx la posizione in memoria dell'array a (load effective address)
    push dx ; copia nello stack il contenuto di dx
    lea dx,result ; salva in dx la posizione in memoria dell'array b (load effective address)
    push dx ; copia nello stack il contenuto di dx
